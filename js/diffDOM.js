        ...
        applyDiff: function(tree, diff) {
            ...
            switch (diff.action) {
                ...
                case 'replaceElement':
                    ...
                    var newNode = this.objToNode(diff.newValue, node.namespaceURI === 'http://www.w3.org/2000/svg');
                    node.parentNode.replaceChild(newNode, node);
                    //this.changed(diff.newValue == '#text' ? newNode.parentNode : newNode);
                    this.changed(node.parentNode);
                    break;
                case 'relocateGroup':
                    alert('relocateGroup')
                ...
                case 'removeElement':
                    ...
                    //jQuery(node).not('.diff-removing').addClass('diff-removing').animate({height: 0, opacity: 0, padding: 0, border: 0, margin: 0}, 500,
                    //    function() {
                    //        console.log(this);
                    //        if (this.parentNode) {
                ...
                case 'addElement':
                    ...
                    var newNode = this.objToNode(diff.element, node.namespaceURI === 'http://www.w3.org/2000/svg');
                    this.changed(newNode);
                ...
                case 'removeTextElement':
                    ...
                    break;
                case 'addTextElement':
                    //do not handle changes here as it seems it will always fire other actions
                    route = diff.route.slice();
                    c = route.splice(route.length - 1, 1)[0];
                    ...
                    if (diff.value.replace(/\s/g, "").length  > 0) {
                        this.changed(node);
                    }
                    node.insertBefore(newNode, node.childNodes[c]);
                    break;
